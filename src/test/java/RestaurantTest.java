...
class RestaurantTest {
    ...
    public static void setup() {
        ...
        restaurant.addToMenu("Dish 3", 269);
        itemNames = new ArrayList<String>();
        itemNames.add("Sweet corn soup");
        itemNames.add("Dish 3");
    }
    //>>>>>>>>>>>>>>>>>>>>>>>>>OPEN/CLOSED<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        LocalTime currentTime = LocalTime.parse("15:22:51");
        when(spiedRestaurant.getCurrentTime()).thenReturn(currentTime);
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        //WRITE UNIT TEST CASE HERE
        Restaurant spiedRestaurant = spy(restaurant);
        LocalTime currentTime = LocalTime.parse("22:22:51");
        when(spiedRestaurant.getCurrentTime()).thenReturn(currentTime);
